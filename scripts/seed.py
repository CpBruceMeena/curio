...
CONTENT = [
    ...
    {"category_id": 33, "title": "Mujh Se Pehli Si Mohabbat", "body": "Mujh se pehli si mohabbat, mere mehboob, na maang / Maine samjha tha ke tu hai to darakhshan hai hayat / مجھ سے پہلی سی محبت مرے محبوب نہ مانگ / میں نے سمجھا تھا کہ تو ہے تو درخشاں ہے حیات", "source": "Faiz Ahmed Faiz, Naqsh-e-Faryadi (1943)", "read_time_secs": 12, "tags": "shayari,faiz,urdu,love,longing", "likes": 10800, "description": "Faiz's heartbreakingly beautiful poem asks his beloved not to demand the same pure love as before\u2014because the poet has now seen the suffering of the world.", "poet": "Faiz Ahmed Faiz"},
    {"category_id": 33, "title": "Kabir Ke Dohe", "body": "Bada hua to kya hua, jaise ped khajoor / Paanthi ko chhaya nahi, phal laage ati door / बड़ा हुआ तो क्या हुआ, जैसे पेड़ खजूर / पंथी को छाया नहीं, फल लागे अति दूर", "source": "Sant Kabir, Kabir Ke Dohe", "read_time_secs": 10, "tags": "shayari,kabir,hindi,dohe,wisdom", "likes": 8500, "description": "Kabir's pointed observation uses the date palm as a metaphor: what good is stature if it offers no shade to the weary traveler?", "poet": "Sant Kabir"},
    {"category_id": 33, "title": "Gulzar Ki Nazm", "body": "Aankhon se utarta hua, dil mein utar jaata hai / Ek rishta aisa bhi hai, jo kuchh bhi nahi rehta / आँखों से उतरता हुआ, दिल में उतर जाता है / एक रिश्ता ऐसा भी है, जो कुछ भी नहीं रहता", "source": "Gulzar, Raat Pashminey Ki", "read_time_secs": 10, "tags": "shayari,gulzar,hindi,relationships", "likes": 7800, "description": "Gulzar captures the paradox of a relationship that exists in the liminal space between presence and absence.", "poet": "Gulzar"},
    {"category_id": 33, "title": "Dil Dhadakne Ka Sabab", "body": "Dil dhadakne ka sabab yaad aaya / Woh teri yaad thi, ab yaad aaya / دل دھڑکنے کا سبب یاد آیا / وہ تیری یاد تھی، اب یاد آیا", "source": "Mir Taqi Mir, Kulliyat-e-Mir", "read_time_secs": 10, "tags": "shayari,mir,urdu,longing,heart", "likes": 8200, "description": "Mir Taqi Mir captures the exquisite pain of rediscovering a forgotten grief. The heartbeat itself remembers what the conscious mind had buried.", "poet": "Mir Taqi Mir"},
    ...
    {"category_id": 33, "title": "Rahim Ke Dohe", "body": "Rahiman dhaga prem ka, mat todo chatkaye / Toote se phir na jude, jude gaanth par jaaye / रहिमन धागा प्रेम का, मत तोड़ो चटकाये / टूटे से फिर न जुड़े, जुड़े गाँठ पर जाये", "source": "Rahim, Rahim Ke Dohe", "read_time_secs": 8, "tags": "shayari,rahim,hindi,love,dohe", "likes": 7100, "description": "Rahim offers timeless relationship wisdom through the metaphor of a thread. Once broken, it can be tied again, but the knot will always remain.", "poet": "Rahim"},
    ...
    {"category_id": 36, "title": "Do Pal Ki Khushi", "body": "Do pal ki khushi ke liye / Saari umr intezaar kiya / Mil gaye to laga / Bus yahi pal / Poori zindagi ka saar hai", "source": "Original Composition for Curio", "read_time_secs": 8, "tags": "hindi,kavita,happiness,moments", "likes": 1100, "description": "A reflective poem about waiting a lifetime for moments of happiness.", "poet": ""},

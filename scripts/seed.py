...
CONTENT = [
    ...
    {"category_id": 10, "title": "The Tulip Mania of 1637 saw a single tulip bulb cost more than a house", "body": "During the Dutch Golden Age, tulip bulbs became a speculative asset. At the peak of the mania, a single bulb of the 'Semper Augustus' tulip sold for 6,000 guilders—more than the cost of a canal house in Amsterdam. It's considered the first recorded speculative bubble.", "source": "Economic History Review", "read_time_secs": 15, "tags": "tulip-mania,bubbles,economics", "likes": 2600, "image_url": "https://images.unsplash.com/photo-1524650359799-842906ca1c06?w=800"},
